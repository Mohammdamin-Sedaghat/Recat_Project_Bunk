...
/**
 * Content for Testomonial documents
 */
interface TestomonialDocumentData {
  /**
   * name field in *Testomonial*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: testomonial.name
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  ...
  /**
   * Job Title field in *Testomonial*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: testomonial.job_title
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  ...
  /**
   * Quote field in *Testomonial*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: testomonial.quote
   * - **Tab**: Main
  ...
  /**
   * Avatar field in *Testomonial*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: testomonial.avatar
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
/**
 * Testomonial document from Prismic
 *
 * - **API ID**: `testomonial`
 * - **Repeatable**: `true`
 * - **Documentation**: https://prismic.io/docs/custom-types
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type TestomonialDocument<Lang extends string = string> =
  prismic.PrismicDocumentWithUID<
    Simplify<TestomonialDocumentData>,
    "testomonial",
    Lang
  >;
...
/**
 * Primary content in *Hero → Horizantal → Primary*
 */
export interface HeroSliceHorizantalPrimary {
  /**
   * Heading field in *Hero → Horizantal → Primary*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.horizantal.primary.heading
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  heading: prismic.TitleField;

  /**
   * Body field in *Hero → Horizantal → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.horizantal.primary.body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;

  /**
   * Button Text field in *Hero → Horizantal → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.horizantal.primary.button_text
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  button_text: prismic.KeyTextField;

  /**
   * Button Link field in *Hero → Horizantal → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.horizantal.primary.button_link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  button_link: prismic.LinkField<
    string,
  ...
  /**
   * Image field in *Hero → Horizantal → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.horizantal.primary.image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;
}
...
/**
 * Horizantal variation for Hero Slice
 *
 * - **API ID**: `horizantal`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type HeroSliceHorizantal = prismic.SharedSliceVariation<
  "horizantal",
  Simplify<HeroSliceHorizantalPrimary>,
  never
>;
 ...
 */
type HeroSliceVariation = HeroSliceDefault | HeroSliceHorizantal;
...
/**
 * Item in *Testimonials → Default → Primary → Repeatables*
 */
export interface TestimonialsSliceDefaultPrimaryRepeatablesItem {
  /**
   * Testimonial field in *Testimonials → Default → Primary → Repeatables*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: testimonials.default.primary.repeatables[].testimonial
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  testimonial: prismic.ContentRelationshipField<"testomonial">;
}
...
export interface TestimonialsSliceDefaultPrimary {
  ...
  /**
   * Repeatables field in *Testimonials → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: testimonials.default.primary.repeatables[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  repeatables: prismic.GroupField<
    Simplify<TestimonialsSliceDefaultPrimaryRepeatablesItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HeroSliceHorizantalPrimary,
      HeroSliceVariation,
      HeroSliceDefault,
      HeroSliceHorizantal,
      TestimonialsSlice,
      TestimonialsSliceDefaultPrimaryRepeatablesItem,
